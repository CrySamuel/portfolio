...
A maioria dos portfólios de backend é um site estático que *afirma* domínio de Spring Boot, Docker e
...
- **API** — Java 21, Spring Boot 3.4, **arquitetura hexagonal** (Ports & Adapters) organizada em
...
| API | Java 21 · Spring Boot 3.4 · Spring Data JPA · Resilience4j · Bucket4j · Caffeine |
